...
import com.Hileb.moremomostories.entity.ai.EntityAIGuideAttack;
...
public class EntityGoldenGuide extends EntityMob implements IMob {
    ...
    public EntityGoldenGuide(World worldIn) {
        super(worldIn);
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(2, new EntityAIGuideAttack(this, 1.0D, false));
